/**
 * Regenerate the web app's PNG favicons from the shared SVG source
 * (`apps/extension/assets/logo.svg` — the brand mark's single source of
 * truth). Keeps the web tab icon in lockstep with the extension toolbar
 * icon, including the thickened stroke at 16px where the 2.5-unit strokes
 * rasterize too thin.
 *
 * Run via `pnpm icons` after changing the SVG.
 */
...
const svgPath = path.resolve(here, "../../../apps/extension/assets/logo.svg");
